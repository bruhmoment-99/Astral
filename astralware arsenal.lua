...
local Library=loadstring(game:HttpGet("https://raw.githubusercontent.com/fusiongreg/BoltsHubV5/main/UI%20LIB"))()
...
local name="Astral%Ware - "..identifyexecutor()..""
...
MiscTabMainSection:Textbox("Custom Chat Message","ez wins from Astral%Ware",function(x)
...
W:Button("å§†rål ☆#4664- Code Dev",function()
    print("Button Pressed")
end)
W:Button("Copy Discord Link To Clip Board",function()
    setclipboard("dsc.gg/astralware")
end)
...
MiscTabMainSection:Textbox("Custom Chat Message","Astral%Ware is ez wins",function(x)
		Client.Values.ChatMsg = tostring(x)
	end)
