game.StarterGui:SetCore("SendNotification",  {
 Title = "Astral%Ware LOADED";
 Text = "Made By astral#4664";
 Icon = "http://www.roblox.com/asset/?id=10457074795";
...
local MainUI = UILibrary.Load("Astral%Ware 😍ZADDY😍 ")
...
local FifthButton = FifthPage.AddButton("Free-Fist [Q]", function()
	...
	wait()
	game.StarterGui:SetCore("SendNotification", {
		Title = "Astral%Ware"; -- the title (ofc)
